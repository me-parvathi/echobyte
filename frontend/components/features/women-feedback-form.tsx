...
import { AlertCircle, Shield, Heart, User } from "lucide-react"
import { Alert, AlertDescription } from "@/components/ui/alert"
import { useFeedback } from "@/hooks/use-feedback"
import { WOMEN_FEEDBACK_CATEGORIES, EmployeeFeedbackCreate } from "@/lib/types"

export default function WomenFeedbackForm() {
  const { 
    feedbackTypes, 
    targets, 
    currentUserManager,
      ...
      <Card className="border-0 shadow-sm">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <CardTitle>Women's Feedback Form</CardTitle>
          </div>
          <CardDescription>Special feedback form for women employees with categories like safe workplace, equal employment, and maternity benefits</CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  {WOMEN_FEEDBACK_CATEGORIES.map((category) => (
              ...
              {currentUserManager && (
                <div className="mt-3 p-3 bg-pink-50 border border-pink-200 rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-pink-800">Your Manager (Auto-selected)</span>
                  </div>
